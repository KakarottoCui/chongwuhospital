...
public class LiuyanfankuiController extends BaseController
{
    ...
    public String list()
    {
        ...
        List<Liuyanfankui> list = service.selectPageExample(example , page , pagesize);   // 获取当前页的行数
    ...
    public String listliuyanren()
    {
        ...
        page = Math.max(1 , page); // 注释同list
            ...
            List<Liuyanfankui> list = service.selectPageExample(example , page , pagesize);
                    assign("totalCount" , request.getAttribute("totalCount"));
        assign("list" , list);
    ...
    public String insert()
    {
        ...
        post.setFankuineirong(Request.get("fankuineirong"));
    ...
    */
    ...
    public String update()
    {
        ...
        post.setLianxidianhua(Request.get("lianxidianhua"));
                if(!Request.get("fankuineirong").equals(""))
        post.setFankuineirong(Request.get("fankuineirong"));
    ...
    */
    ...
    public String delete()
    {
        ...
        HashMap map = Query.make("liuyanfankui").find(id);
